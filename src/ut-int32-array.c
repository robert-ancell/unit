...
static const int32_t *ut_int32_array_get_const_data(UtObject *object) {
  UtInt32Array *self = (UtInt32Array *)object;
  return self->data;
}

static int32_t *ut_int32_array_get_writable_data(UtObject *object) {
  UtInt32Array *self = (UtInt32Array *)object;
  return self->data;
}
...
static bool ut_int32_array_equal(UtObject *object, UtObject *other) {
  UtInt32Array *self = (UtInt32Array *)object;
  if (!ut_object_implements_int32_list(other)) {
    return false;
  }
  ...
  for (size_t i = 0; i < self->data_length; i++) {
    if (self->data[i] != ut_int32_list_get_element(other, i)) {
      return false;
    }
  }
  return true;
...
static UtInt32ListInterface int32_list_interface = {
    ...
    .get_data = ut_int32_array_get_const_data,
    .get_writable_data = ut_int32_array_get_writable_data,
...
UtObject *ut_int32_array_new_sized(size_t length) {
  ...
  self->data = malloc(sizeof(int32_t) * length);
  self->data_length = length;
