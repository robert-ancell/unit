...
/// Creates a new XDG toplevel object with [id] on [client].
...
/// [seat] and [serial] indicates the event this is in response to.
///
...
/// If provided, request this surface is placed on [output].
///
/// !arg-type output UtXdgOutput NULL
