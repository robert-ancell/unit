...
static void check_png(uint32_t width, uint32_t height, uint8_t bit_depth,
                      UtPngColorType color_type, const char *hex_palette_data,
...
int main(int argc, char **argv) {
  check_png(
      1, 1, 8, UT_PNG_COLOR_TYPE_GREYSCALE, NULL, NULL, "00",
  ...
  check_png(
      2, 2, 8, UT_PNG_COLOR_TYPE_GREYSCALE, NULL, NULL, "007fccff",
  ...
  check_png(2, 2, 8, UT_PNG_COLOR_TYPE_TRUECOLOR, NULL, NULL,
