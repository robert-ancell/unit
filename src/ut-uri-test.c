...
int main(int argc, char **argv) {
  ...
  ut_assert_null(ut_uri_get_user_info(ftp_uri));
  ...
  ut_assert_null(ut_uri_get_query(ftp_uri));
  ut_assert_null(ut_uri_get_fragment(ftp_uri));
  ...
  ut_assert_null(ut_uri_get_user_info(http_uri));
  ...
  ut_assert_null(ut_uri_get_query(http_uri));
  ut_assert_null(ut_uri_get_fragment(http_uri));
  ...
  ut_assert_null(ut_uri_get_user_info(ldap_uri));
  ...
  ut_assert_null(ut_uri_get_fragment(ldap_uri));
  ...
  ut_assert_null(ut_uri_get_user_info(mailto_uri));
  ut_assert_null(ut_uri_get_host(mailto_uri));
  ut_assert_int_equal(ut_uri_get_port(mailto_uri), 0);
  ut_assert_cstring_equal(ut_uri_get_path(mailto_uri), "John.Doe@example.com");
  ut_assert_null(ut_uri_get_query(mailto_uri));
  ut_assert_null(ut_uri_get_fragment(mailto_uri));
  ...
  ut_assert_null(ut_uri_get_user_info(news_uri));
  ut_assert_null(ut_uri_get_host(news_uri));
  ut_assert_int_equal(ut_uri_get_port(news_uri), 0);
  ut_assert_cstring_equal(ut_uri_get_path(news_uri),
                          "comp.infosystems.www.servers.unix");
  ut_assert_null(ut_uri_get_query(news_uri));
  ut_assert_null(ut_uri_get_fragment(news_uri));
  ...
  ut_assert_null(ut_uri_get_user_info(tel_uri));
  ut_assert_null(ut_uri_get_host(tel_uri));
  ut_assert_int_equal(ut_uri_get_port(tel_uri), 0);
  ut_assert_cstring_equal(ut_uri_get_path(tel_uri), "+1-816-555-1212");
  ut_assert_null(ut_uri_get_query(tel_uri));
  ut_assert_null(ut_uri_get_fragment(tel_uri));
  ...
  ut_assert_null(ut_uri_get_user_info(telnet_uri));
  ...
  ut_assert_null(ut_uri_get_query(telnet_uri));
  ut_assert_null(ut_uri_get_fragment(telnet_uri));
  ...
  ut_assert_null(ut_uri_get_user_info(urn_uri));
  ut_assert_null(ut_uri_get_host(urn_uri));
  ut_assert_int_equal(ut_uri_get_port(urn_uri), 0);
  ut_assert_cstring_equal(ut_uri_get_path(urn_uri),
                          "oasis:names:specification:docbook:dtd:xml:4.1.2");
  ut_assert_null(ut_uri_get_query(urn_uri));
  ut_assert_null(ut_uri_get_fragment(urn_uri));
  ...
  ut_assert_null(ut_uri_get_user_info(rfc_uri));
