...
static bool ut_asn1_graphic_string_type_equal(UtObject *object,
                                              UtObject *other) {
  return ut_object_is_asn1_graphic_string_type(other);
}

static UtObjectInterface object_interface = {
    .type_name = "UtAsn1GraphicStringType",
    .equal = ut_asn1_graphic_string_type_equal,
