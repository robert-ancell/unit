...
static bool ut_asn1_null_type_matches_tag(UtObject *object, UtObject *tag) {
...
static UtAsn1TypeInterface asn1_type_interface = {
    ...
    .matches_tag = ut_asn1_null_type_matches_tag};

static bool ut_asn1_null_type_equal(UtObject *object, UtObject *other) {
  return ut_object_is_asn1_null_type(other);
}

static UtObjectInterface object_interface = {
    .type_name = "UtAsn1NullType",
    .equal = ut_asn1_null_type_equal,
