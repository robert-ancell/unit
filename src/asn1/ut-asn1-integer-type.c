...
static bool ut_asn1_integer_type_matches_tag(UtObject *object, UtObject *tag) {
...
static UtAsn1TypeInterface asn1_type_interface = {
    ...
    .matches_tag = ut_asn1_integer_type_matches_tag};

static bool ut_asn1_integer_type_equal(UtObject *object, UtObject *other) {
  return ut_object_is_asn1_integer_type(other);
}

static UtObjectInterface object_interface = {
    .type_name = "UtAsn1IntegerType",
    .equal = ut_asn1_integer_type_equal,
