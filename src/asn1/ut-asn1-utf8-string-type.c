...
static bool ut_asn1_utf8_string_type_equal(UtObject *object, UtObject *other) {
  return ut_object_is_asn1_utf8_string_type(other);
}
...
static UtObjectInterface object_interface = {
    ...
    .equal = ut_asn1_utf8_string_type_equal,
