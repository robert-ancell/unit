...
int main(int argc, char **argv) {
  ...
  UtObjectRef list4 = ut_bit_list_new();
  ...
  UtObjectRef list5 = ut_bit_list_new();
  ...
  UtObjectRef list6 = ut_bit_list_new();
