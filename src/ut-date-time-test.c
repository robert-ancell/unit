...
int main(int argc, char **argv) {
  UtObjectRef dt1 = ut_date_time_new(2023, 7, 19, 20, 54, 46);
  UtObjectRef dt2 = ut_date_time_new(2023, 7, 19, 20, 54, 46);
  UtObjectRef dt3 = ut_date_time_new(1991, 8, 26, 6, 12, 8);
