...
void ut_int64_list_append(UtObject *object, int64_t value) {
  ut_int64_list_append_block(object, &value, 1);
}
...
void ut_int64_list_prepend(UtObject *object, int64_t value) {
  ut_int64_list_prepend_block(object, &value, 1);
}
...
void ut_int64_list_insert(UtObject *object, size_t index, int64_t value) {
  ut_int64_list_insert_block(object, index, &value, 1);
}
