...
static UtObjectInterface callback_data_object_interface = {
    .type_name = "SyncCallbackData", .interfaces = {{NULL, NULL}}};
...
static void list_system_counters_reply_cb(UtObject *object, uint8_t data0,
  ...
  if (callback_data->callback != NULL) {
    UtX11ClientSyncListSystemCountersCallback callback =
        (UtX11ClientSyncListSystemCountersCallback)callback_data->callback;
...
static void query_counter_reply_cb(UtObject *object, uint8_t data0,
  ...
  if (callback_data->callback != NULL) {
    UtX11ClientSyncQueryCounterCallback callback =
        (UtX11ClientSyncQueryCounterCallback)callback_data->callback;
